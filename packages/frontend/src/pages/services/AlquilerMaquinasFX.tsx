...
const AlquilerMaquinasFX = () => {
  const pageData = {
    ...
    introduction: `Alquiler de <strong>máquinas de efectos especiales</strong>: humo, niebla baja, cañones CO2, confeti, burbujas, nieve. Efectos espectaculares para bodas, conciertos y eventos.`,
