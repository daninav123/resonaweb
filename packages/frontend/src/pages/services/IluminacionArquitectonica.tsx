...
const IluminacionArquitectonica = () => {
  const pageData = {
    ...
    introduction: `<strong>Iluminación arquitectónica</strong> para eventos: uplights LED RGB de batería, bañadores de fachada potentes. Ilumina paredes, jardines, edificios con colores personalizados.`,
