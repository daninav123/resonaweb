...
const IluminacionEscenarios = () => {
  const pageData = {
    ...
    introduction: `<strong>Iluminación profesional para escenarios</strong>: moving heads, PAR LED de alta potencia, seguimientos, strobos. Para conciertos, shows, teatro y espectáculos.`,
