...
const AlquilerMovingHeads = () => {
  const pageData = {
    ...
    introduction: `Alquiler de <strong>moving heads profesionales</strong>: Beam, Spot, Wash. Luces robotizadas inteligentes con movimiento Pan/Tilt, gobos, prisma. Control DMX. Perfectas para discotecas móviles y eventos.`,
