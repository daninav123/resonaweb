...
const AlquilerIluminacionBodas = () => {
  const pageData = {
    ...
    introduction: `<strong>Iluminación completa para bodas</strong> en Valencia: luces ambientales LED, iluminación arquitectónica uplights, efectos pista de baile. Crea la atmósfera perfecta para tu gran día.`,
