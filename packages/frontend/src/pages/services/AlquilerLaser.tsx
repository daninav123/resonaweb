...
const AlquilerLaser = () => {
  const pageData = {
    ...
    introduction: `Alquiler de <strong>láser profesional RGB</strong> para eventos. Efectos de rayos láser sincronizados con música. Control DMX. Perfecto para conciertos, discotecas móviles y grandes eventos.`,
