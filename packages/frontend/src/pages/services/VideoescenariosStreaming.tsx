...
const VideoescenariosStreaming = () => {
  const pageData = {
    ...
    introduction: `<strong>Videoescenarios profesionales y streaming</strong>: múltiples cámaras, mesa de vídeo, pantallas LED. Streaming en vivo YouTube, Facebook, Zoom. Grabación profesional incluida.`,
