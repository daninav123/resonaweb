...
const IluminacionLEDProfesional = () => {
  const pageData = {
    ...
    introduction: `<strong>Iluminación LED profesional</strong> para eventos: focos PAR LED RGB/RGBW, barras LED, uplights, bañadores. Control DMX. Colores personalizados para tu evento.`,
