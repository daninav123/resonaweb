    ...
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-2">
      {tooltipOpen && (
        <button
          ...
          className="relative animate-fade-in rounded-lg bg-white px-3 py-2 text-sm font-medium text-gray-800 shadow-lg hover:bg-gray-50"
          aria-label="Cerrar tooltip"
        >
          {tooltip}
          <span className="absolute -bottom-1 right-5 h-3 w-3 rotate-45 bg-white" />
        </button>
      )}
      <a
        href={href}
