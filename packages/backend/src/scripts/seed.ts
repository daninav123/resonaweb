...
async function main() {
  ...
  const productos = [
    // FOTOGRAFÍA Y VIDEO
    {
      ...
      longDescription: 'La Sony A7 III es la cámara ideal para fotografía de bodas profesional. Con su sensor full-frame de 24.2MP y capacidades de video 4K, capturarás cada momento especial con calidad excepcional.',
      pricePerDay: 85,
      pricePerWeekend: 150,
      pricePerWeek: 400,
      stock: 5,
    ...
    },
    {
      ...
      longDescription: 'El objetivo perfecto para retratos de boda. La apertura f/1.2 proporciona un bokeh cremoso y hermoso, ideal para destacar a los novios.',
      pricePerDay: 45,
      pricePerWeekend: 80,
      pricePerWeek: 200,
      stock: 8,
    ...
    },
    {
      ...
      longDescription: 'Captura vistas aéreas impresionantes de la ceremonia y el lugar de celebración. El DJI Mavic 3 Pro ofrece video 4K y es perfecto para crear recuerdos únicos.',
      pricePerDay: 120,
      pricePerWeekend: 200,
      pricePerWeek: 550,
      stock: 3,
    ...
    // ILUMINACIÓN
    {
      ...
      longDescription: 'Panel LED profesional con 1000W de potencia, control de temperatura de color y dimmer integrado. Perfecto para iluminar espacios amplios.',
      pricePerDay: 35,
      pricePerWeekend: 60,
      pricePerWeek: 150,
      stock: 10,
    ...
    },
    {
      ...
      longDescription: 'Flash profesional con batería incorporada, perfecto para sesiones en exteriores. TTL, HSS y reciclaje rápido.',
      pricePerDay: 40,
      pricePerWeekend: 70,
      pricePerWeek: 180,
      stock: 6,
    ...
    },
    {
      ...
      longDescription: 'Crea la atmósfera perfecta para tu boda con estos focos RGB controlables vía DMX o app móvil. Incluye efectos predefinidos.',
      pricePerDay: 25,
      pricePerWeekend: 45,
      pricePerWeek: 110,
      stock: 15,
    ...
    // SONIDO
    {
      ...
      longDescription: 'Sistema de sonido profesional perfecto para ceremonias y recepciones. Calidad de audio excepcional con WiFi integrado para control remoto.',
      pricePerDay: 60,
      pricePerWeekend: 100,
      pricePerWeek: 250,
      stock: 8,
    ...
    },
    {
      ...
      longDescription: 'El micrófono más utilizado en el mundo para voces. Perfecto para discursos, celebrantes y animadores.',
      pricePerDay: 15,
      pricePerWeekend: 25,
      pricePerWeek: 60,
      stock: 20,
    ...
    },
    {
      ...
      longDescription: 'Mesa de mezclas profesional con 16 canales, efectos digitales, compresor y ecualizador. Incluye interfaz USB.',
      pricePerDay: 50,
      pricePerWeekend: 85,
      pricePerWeek: 210,
      stock: 4,
    ...
    // DECORACIÓN
    {
      ...
      description: 'Arco decorativo de metal con flores artificiales premium.',
      longDescription: 'Hermoso arco ceremonial de 2.5m de altura, decorado con flores artificiales de alta calidad en tonos blancos y verdes.',
      pricePerDay: 80,
      pricePerWeekend: 140,
      pricePerWeek: 350,
      stock: 3,
    ...
    },
    {
      ...
      description: 'Letras gigantes iluminadas LOVE de 1.2m de altura.',
      longDescription: 'Letras luminosas de metacrilato con luces LED cálidas. Perfectas para photocall y decoración de la recepción.',
      pricePerDay: 70,
      pricePerWeekend: 120,
      pricePerWeek: 300,
      stock: 2,
    ...
    },
    {
      ...
      description: 'Fondo de tela blanca con estructura para photocall.',
      longDescription: 'Sistema completo de photocall con estructura de aluminio y fondo de tela blanca sin arrugas. Montaje rápido.',
      pricePerDay: 45,
      pricePerWeekend: 75,
      pricePerWeek: 180,
      stock: 5,
    ...
    // MOBILIARIO
    {
      ...
      description: 'Pack de 10 sillas Chiavari doradas elegantes para eventos.',
      longDescription: 'Las clásicas sillas Chiavari en acabado dorado. Ligeras, elegantes y cómodas. Incluye cojines blancos.',
      pricePerDay: 40,
      pricePerWeekend: 70,
      pricePerWeek: 170,
      stock: 20,
    ...
    },
    {
      ...
      slug: 'mesa-imperial',
      description: 'Mesa imperial rectangular de madera para presidencia.',
      longDescription: 'Mesa imperial de madera noble de 3 metros. Perfecta para la mesa de los novios con capacidad para 8 personas.',
      pricePerDay: 55,
      pricePerWeekend: 95,
      pricePerWeek: 230,
      stock: 6,
    ...
    },
    {
      ...
      description: 'Pack de 5 mesas altas tipo cocktail con funda blanca.',
      longDescription: 'Mesas altas de 110cm para cóctel o aperitivo. Incluyen fundas blancas stretch. Diámetro 80cm.',
      pricePerDay: 30,
      pricePerWeekend: 50,
      pricePerWeek: 120,
      stock: 10,
