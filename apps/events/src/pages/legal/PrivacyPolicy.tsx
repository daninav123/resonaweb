      ...
      <div className="mx-auto max-w-[820px] px-5 pb-24 pt-32 md:px-10 md:pt-44">
        <div>
          ...
          <div className="prose max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-ink prose-p:leading-relaxed prose-p:text-ink-700 prose-a:text-ink prose-a:underline-offset-4 prose-strong:text-ink prose-li:text-ink-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">2. Principios del Tratamiento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">3. Datos que Recopilamos</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.1 Datos de Identificación</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.2 Datos de Navegación</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
                <li>Dirección IP</li>
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.3 Datos de Transacciones</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Finalidad del Tratamiento</h2>
              ...
              <div className="space-y-4">
                <div className="bg-paper rounded-lg p-4">
                  <h4 className="font-semibold text-ink mb-2">Gestión de Reservas y Pedidos</h4>
                ...
                <div className="bg-paper rounded-lg p-4">
                  <h4 className="font-semibold text-ink mb-2">Comunicaciones Comerciales</h4>
                  <p className="text-sm text-ink-700 mb-2">
                ...
                <div className="bg-paper rounded-lg p-4">
                  <h4 className="font-semibold text-ink mb-2">Atención al Cliente</h4>
                  <p className="text-sm text-ink-700 mb-2">
                ...
                <div className="bg-paper rounded-lg p-4">
                  <h4 className="font-semibold text-ink mb-2">Obligaciones Legales</h4>
                  <p className="text-sm text-ink-700 mb-2">
                ...
                <div className="bg-paper rounded-lg p-4">
                  <h4 className="font-semibold text-ink mb-2">Análisis y Mejora</h4>
                  <p className="text-sm text-ink-700 mb-2">
                    <strong>Base legal:</strong> Interés legítimo
                  </p>
                  <p className="text-sm text-ink-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">5. Conservación de Datos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Destinatarios de los Datos</h2>
              ...
              <div className="space-y-3">
                <div className="border-l-4 border-accent-600 pl-4">
                  <h4 className="font-semibold text-ink">Proveedores de Servicios</h4>
                  <ul className="list-disc pl-6 text-sm text-ink-700 space-y-1 mt-2">
                ...
                <div className="border-l-4 border-accent-600 pl-4">
                  <h4 className="font-semibold text-ink">Administraciones Públicas</h4>
                ...
                <div className="border-l-4 border-accent-600 pl-4">
                  <h4 className="font-semibold text-ink">Terceros con Consentimiento</h4>
                  <p className="text-sm text-ink-700 mt-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Transferencias Internacionales</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">8. Tus Derechos</h2>
              ...
              <div className="bg-accent-50 border-l-4 border-accent-500 p-4 my-4">
                <h4 className="font-semibold text-ink mb-2">¿Cómo ejercer tus derechos?</h4>
                <p className="text-sm text-ink-700 mb-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">9. Seguridad de los Datos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">10. Menores de Edad</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">11. Redes Sociales</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">12. Modificaciones</h2>
