      ...
      <div className="mx-auto max-w-[820px] px-5 pb-24 pt-32 md:px-10 md:pt-44">
        <div>
          ...
          <div className="prose max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-ink prose-p:leading-relaxed prose-p:text-ink-700 prose-a:text-ink prose-a:underline-offset-4 prose-strong:text-ink prose-li:text-ink-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">2. ¿Para qué usamos cookies?</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">3. Tipos de Cookies que Utilizamos</h2>
              ...
              <div className="space-y-6">
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-ink mb-2">Cookies Técnicas (Necesarias)</h4>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-ink mb-2">Cookies de Análisis</h4>
                      <p className="text-sm text-ink-700 mb-2">
                      ...
                      <div className="mt-3 p-3 bg-paper rounded text-xs text-ink-600">
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-ink mb-2">Cookies de Personalización</h4>
                      <p className="text-sm text-ink-700 mb-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Cookies de Terceros</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">5. ¿Cómo Gestionar las Cookies?</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">5.1 Panel de Configuración</h3>
              <p className="text-ink-700 mb-4">
              ...
              <div className="space-y-2 mb-4">
                <div className="bg-paper rounded p-3">
                  <p className="text-sm font-semibold text-ink">Chrome:</p>
                  <p className="text-sm text-ink-700">
                ...
                <div className="bg-paper rounded p-3">
                  <p className="text-sm font-semibold text-ink">Firefox:</p>
                  <p className="text-sm text-ink-700">
                ...
                <div className="bg-paper rounded p-3">
                  <p className="text-sm font-semibold text-ink">Safari:</p>
                  <p className="text-sm text-ink-700">
                ...
                <div className="bg-paper rounded p-3">
                  <p className="text-sm font-semibold text-ink">Edge:</p>
                  <p className="text-sm text-ink-700">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">5.3 Desactivar Google Analytics</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Consentimiento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Actualizaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">8. Más Información</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">9. Contacto</h2>
