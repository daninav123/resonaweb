      ...
      <div className="mx-auto max-w-[820px] px-5 pb-24 pt-32 md:px-10 md:pt-44">
        <div>
          ...
          <div className="prose max-w-none prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-ink prose-p:leading-relaxed prose-p:text-ink-700 prose-a:text-ink prose-a:underline-offset-4 prose-strong:text-ink prose-li:text-ink-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">2. Objeto del Servicio</h2>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">3. Proceso de Reserva</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.1 Solicitud de Presupuesto</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.2 Confirmación de Reserva</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">3.3 Disponibilidad</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Precios y Tarifas</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">4.1 Tarifas de Alquiler</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">4.2 Servicios Adicionales</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">4.3 IVA</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">5. Modalidades de Pago</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">5.1 Opciones de Pago</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">5.2 Métodos de Pago Aceptados</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">5.3 Fianza</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Entrega y Recogida</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">6.1 Opciones de Entrega</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">6.2 Horarios</h3>
              <p className="text-ink-700 mb-4">
                Entrega y recogida en horario laboral (09:00 - 20:00). Servicios fuera de horario 
                disponibles bajo petición con suplemento.
              </p>

              <h3 className="text-xl font-semibold text-ink-800 mb-3">6.3 Responsabilidad</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Uso del Equipo</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">7.1 Condiciones de Uso</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">7.2 Prohibiciones</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">8. Cancelaciones y Modificaciones</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">8.1 Cancelación por el Cliente</h3>
              <ul className="list-disc pl-6 text-ink-700 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">8.2 Modificaciones</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">8.3 Cancelación por ReSona Events</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">9. Responsabilidades</h2>
              
              <h3 className="text-xl font-semibold text-ink-800 mb-3">9.1 Responsabilidad del Cliente</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">9.2 Responsabilidad de ReSona Events</h3>
              <p className="text-ink-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-ink-800 mb-3">9.3 Limitación de Responsabilidad</h3>
              <p className="text-ink-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">10. Garantías y Mantenimiento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">11. Protección de Datos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">12. Propiedad Intelectual</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">13. Legislación Aplicable</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">14. Modificaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-ink mb-4">15. Contacto</h2>
