...
export default function CookiesPolicy() {
  return (
    <div className="min-h-screen bg-ink py-12">
      <SEOHead
        title="Política de Cookies | ReSona Rent"
        description="Qué cookies usa ReSona Rent, para qué sirven y cómo gestionar tus preferencias en nuestra web de alquiler audiovisual en Valencia."
        canonicalUrl="https://resonarent.com/politica-cookies"
      />
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-ink-800 rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-cream mb-6">Política de Cookies</h1>
          ...
          <div className="prose prose-invert prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">1. ¿Qué son las cookies?</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">2. ¿Para qué usamos cookies?</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">3. Tipos de Cookies que Utilizamos</h2>
              
              <div className="space-y-6">
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    <span className="bg-emerald-500/15 text-emerald-300 text-xs font-semibold px-2 py-1 rounded mr-3">
                      ESENCIALES
                    </span>
                    <div className="flex-1">
                      <h4 className="font-semibold text-cream mb-2">Cookies Técnicas (Necesarias)</h4>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    <span className="bg-resona/15 text-resona-light text-xs font-semibold px-2 py-1 rounded mr-3">
                      ANALÍTICAS
                    </span>
                    <div className="flex-1">
                      <h4 className="font-semibold text-cream mb-2">Cookies de Análisis</h4>
                      <p className="text-sm text-cream/75 mb-2">
                      ...
                      <div className="mt-3 p-3 bg-ink rounded text-xs text-cream/65">
                        ...
                        <p className="mt-2">
                          <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-resona-light hover:underline">
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-cream mb-2">Cookies de Personalización</h4>
                      <p className="text-sm text-cream/75 mb-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">4. Cookies de Terceros</h2>
              ...
              <div className="space-y-3">
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">🔒 Stripe (Procesamiento de Pagos)</h4>
                  <p className="text-sm text-cream/75 mb-2">
                    <strong>Finalidad:</strong> Procesar pagos de forma segura
                  </p>
                  <p className="text-sm text-cream/75">
                    <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-resona-light hover:underline">
                ...
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">📊 Google Analytics</h4>
                  <p className="text-sm text-cream/75 mb-2">
                    <strong>Finalidad:</strong> Estadísticas de uso del sitio
                  </p>
                  <p className="text-sm text-cream/75">
                    <a href="https://policies.google.com/technologies/cookies" target="_blank" rel="noopener noreferrer" className="text-resona-light hover:underline">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">5. ¿Cómo Gestionar las Cookies?</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.1 Panel de Configuración</h3>
              <p className="text-cream/75 mb-4">
                Puedes gestionar tus preferencias de cookies desde nuestro panel de configuración 
                en cualquier momento:
              </p>
              
              <button className="bg-resona text-white px-6 py-3 rounded-lg hover:bg-resona-dark transition mb-6">
                ⚙️ Configurar Cookies
              </button>

              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.2 Desde tu Navegador</h3>
              <p className="text-cream/75 mb-4">
              ...
              <div className="space-y-2 mb-4">
                <div className="bg-ink rounded p-3">
                  <p className="text-sm font-semibold text-cream">Chrome:</p>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-ink rounded p-3">
                  <p className="text-sm font-semibold text-cream">Firefox:</p>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-ink rounded p-3">
                  <p className="text-sm font-semibold text-cream">Safari:</p>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-ink rounded p-3">
                  <p className="text-sm font-semibold text-cream">Edge:</p>
                  <p className="text-sm text-cream/75">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.3 Desactivar Google Analytics</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">6. Consentimiento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">7. Actualizaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">8. Más Información</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">9. Contacto</h2>
