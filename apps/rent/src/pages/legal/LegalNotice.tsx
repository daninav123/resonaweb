    ...
    <div className="min-h-screen bg-ink py-12">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-ink-800 rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-cream mb-6">Aviso Legal</h1>
          ...
          <div className="prose prose-invert prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">1. Datos Identificativos</h2>
              ...
              <div className="bg-resona/10 border-l-4 border-blue-500 p-4 my-4">
                <p className="text-sm text-cream/75 space-y-1">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">2. Objeto y Aceptación</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">3. Condiciones de Acceso y Uso</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.1 Carácter Gratuito</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.2 Uso Correcto</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">4. Contenidos</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.1 Veracidad</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.2 Disponibilidad</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.3 Modificaciones</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">5. Propiedad Intelectual e Industrial</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.1 Derechos de Autor</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.2 Protección Legal</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.3 Uso Permitido</h3>
              <p className="text-cream/75 mb-4">
                El usuario puede:
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">6. Enlaces Externos (Links)</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">6.1 Enlaces Salientes</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">6.2 Enlaces Entrantes</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">7. Protección de Datos</h2>
              
              <p className="text-cream/75 mb-4">
                El tratamiento de datos personales se rige por nuestra <Link to="/politica-privacidad" className="text-resona-light hover:underline">Política de Privacidad</Link>, 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">8. Cookies</h2>
              
              <p className="text-cream/75 mb-4">
                Este sitio web utiliza cookies propias y de terceros. Para más información, 
                consulta nuestra <Link to="/politica-cookies" className="text-resona-light hover:underline">Política de Cookies</Link>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">9. Responsabilidad</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">9.1 Limitación de Responsabilidad</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">9.2 Exclusión de Garantías</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">10. Legislación Aplicable y Jurisdicción</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">10.1 Legislación</h3>
              <p className="text-cream/75 mb-4">
                El presente Aviso Legal se rige por la legislación española vigente.
              </p>

              <h3 className="text-xl font-semibold text-cream/90 mb-3">10.2 Resolución de Conflictos</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">10.3 Resolución Online de Litigios</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">11. Modificaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">12. Normativa Aplicable</h2>
            ...
            <div className="bg-resona/10 border-l-4 border-blue-500 p-4 my-6">
              ...
              <ul className="text-sm text-cream/75 space-y-1">
                ...
                <li>• <Link to="/politica-privacidad" className="text-resona-light hover:underline">Política de Privacidad</Link></li>
