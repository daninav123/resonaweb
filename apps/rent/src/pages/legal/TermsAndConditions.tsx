    ...
    <div className="min-h-screen bg-ink py-12">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-ink-800 rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-cream mb-6">Términos y Condiciones</h1>
          ...
          <div className="prose prose-invert prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">1. Información General</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">2. Objeto del Servicio</h2>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">3. Proceso de Reserva</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.1 Solicitud de Presupuesto</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.2 Confirmación de Reserva</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.3 Disponibilidad</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">4. Precios y Tarifas</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.1 Tarifas de Alquiler</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.2 Servicios Adicionales</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">4.3 IVA</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">5. Modalidades de Pago</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.1 Opciones de Pago</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.2 Métodos de Pago Aceptados</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">5.3 Fianza</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">6. Entrega y Recogida</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">6.1 Opciones de Entrega</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">6.2 Horarios</h3>
              <p className="text-cream/75 mb-4">
                Entrega y recogida en horario laboral (09:00 - 20:00). Servicios fuera de horario 
                disponibles bajo petición con suplemento.
              </p>

              <h3 className="text-xl font-semibold text-cream/90 mb-3">6.3 Responsabilidad</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">7. Uso del Equipo</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">7.1 Condiciones de Uso</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">7.2 Prohibiciones</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">8. Cancelaciones y Modificaciones</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">8.1 Cancelación por el Cliente</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">8.2 Modificaciones</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">8.3 Cancelación por ReSona Rent</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">9. Responsabilidades</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">9.1 Responsabilidad del Cliente</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">9.2 Responsabilidad de ReSona Rent</h3>
              <p className="text-cream/75 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">9.3 Limitación de Responsabilidad</h3>
              <p className="text-cream/75 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">10. Garantías y Mantenimiento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">11. Protección de Datos</h2>
              
              <p className="text-cream/75 mb-4">
                Los datos personales proporcionados serán tratados conforme al <Link to="/politica-privacidad" className="text-resona-light hover:underline">Política de Privacidad</Link> y 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">12. Propiedad Intelectual</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">13. Legislación Aplicable</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">14. Modificaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">15. Contacto</h2>
