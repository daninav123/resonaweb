  ...
  return (
    <div className="min-h-screen bg-ink py-12">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-ink-800 rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-cream mb-6">Política de Privacidad</h1>
          ...
          <div className="prose prose-invert prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">1. Responsable del Tratamiento</h2>
              
              <div className="bg-resona/10 border-l-4 border-blue-500 p-4 my-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">2. Principios del Tratamiento</h2>
              
              <p className="text-cream/75 mb-4">
                El tratamiento de tus datos personales se rige por los siguientes principios:
              </p>
              
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">3. Datos que Recopilamos</h2>
              
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.1 Datos de Identificación</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.2 Datos de Navegación</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
                <li>Dirección IP</li>
                <li>Navegador y dispositivo</li>
                <li>Páginas visitadas</li>
                <li>Fecha y hora de acceso</li>
                <li>Cookies (ver <Link to="/politica-cookies" className="text-resona-light hover:underline">Política de Cookies</Link>)</li>
              </ul>

              <h3 className="text-xl font-semibold text-cream/90 mb-3">3.3 Datos de Transacciones</h3>
              <ul className="list-disc pl-6 text-cream/75 space-y-2 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">4. Finalidad del Tratamiento</h2>
              ...
              <div className="space-y-4">
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">Gestión de Reservas y Pedidos</h4>
                  <p className="text-sm text-cream/75 mb-2">
                ...
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">Comunicaciones Comerciales</h4>
                  <p className="text-sm text-cream/75 mb-2">
                ...
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">Atención al Cliente</h4>
                  <p className="text-sm text-cream/75 mb-2">
                ...
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">Obligaciones Legales</h4>
                  <p className="text-sm text-cream/75 mb-2">
                ...
                <div className="bg-ink rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">Análisis y Mejora</h4>
                  <p className="text-sm text-cream/75 mb-2">
                    <strong>Base legal:</strong> Interés legítimo
                  </p>
                  <p className="text-sm text-cream/75">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">5. Conservación de Datos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">6. Destinatarios de los Datos</h2>
              ...
              <div className="space-y-3">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-cream">Proveedores de Servicios</h4>
                  <ul className="list-disc pl-6 text-sm text-cream/75 space-y-1 mt-2">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-cream">Administraciones Públicas</h4>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold text-cream">Terceros con Consentimiento</h4>
                  <p className="text-sm text-cream/75 mt-2">
              ...
              <div className="bg-amber-500/10 border-l-4 border-yellow-500 p-4 my-4">
                <p className="text-sm text-cream/75">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">7. Transferencias Internacionales</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">8. Tus Derechos</h2>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Acceso</h4>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Rectificación</h4>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Supresión</h4>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Limitación</h4>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Portabilidad</h4>
                  <p className="text-sm text-cream/75">
                ...
                <div className="bg-resona/10 rounded-lg p-4">
                  <h4 className="font-semibold text-cream mb-2">✓ Oposición</h4>
                  <p className="text-sm text-cream/75">
              ...
              <div className="bg-emerald-500/10 border-l-4 border-green-500 p-4 my-4">
                <h4 className="font-semibold text-cream mb-2">¿Cómo ejercer tus derechos?</h4>
                <p className="text-sm text-cream/75 mb-2">
              ...
              <p className="text-sm text-cream/75">
                <strong>AEPD:</strong> <a href="https://www.aepd.es" target="_blank" rel="noopener noreferrer" className="text-resona-light hover:underline">www.aepd.es</a>
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">9. Seguridad de los Datos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">10. Menores de Edad</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">11. Redes Sociales</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">12. Modificaciones</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-cream mb-4">13. Contacto</h2>
            ...
            <div className="bg-resona/10 border-l-4 border-blue-500 p-4 my-6">
              <h3 className="font-semibold text-cream mb-2">📋 Documentos Relacionados</h3>
              <ul className="text-sm text-cream/75 space-y-1">
                <li>• <Link to="/terminos-condiciones" className="text-resona-light hover:underline">Términos y Condiciones</Link></li>
                <li>• <Link to="/politica-cookies" className="text-resona-light hover:underline">Política de Cookies</Link></li>
                <li>• <Link to="/aviso-legal" className="text-resona-light hover:underline">Aviso Legal</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-cream/10">
            <Link 
              to="/" 
              className="text-resona-light hover:text-blue-800 font-medium"
            >
