...
const AlquilerMesaMezclaDJ = () => {
  const pageData = {
    ...
    metaDescription: "Mesas de mezclas DJ profesionales. Pioneer DJM-900, Allen & Heath. Con CDJs. Técnico opcional. ☎️ 613 88 14 14",
...
Hemos trabajado en eventos de todo tipo en Valencia: <a href="/servicios/sonido-bodas-valencia" class="text-resona-light hover:underline font-semibold">bodas</a>, fiestas, eventos privados en espacios emblemáticos de la ciudad. Combinamos con <a href="/servicios/alquiler-dj-valencia" class="text-resona-light hover:underline font-semibold">servicio de DJ completo</a>.`,
