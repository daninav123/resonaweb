...
Hemos trabajado en eventos de todo tipo en Valencia: conciertos, eventos, ferias en espacios emblemáticos de la ciudad. Utilizamos para <a href="/servicios/iluminacion-led-profesional" class="text-resona-light hover:underline font-semibold">iluminación profesional</a> y <a href="/servicios/alquiler-sonido-valencia" class="text-resona-light hover:underline font-semibold">sistemas de sonido</a>.`,
