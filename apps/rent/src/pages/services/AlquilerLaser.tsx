...
Hemos trabajado en eventos de todo tipo en Valencia: conciertos, festivales, eventos en espacios emblemáticos de la ciudad. Combinamos con <a href="/servicios/iluminacion-led-profesional" class="text-primary-600 hover:underline font-semibold">iluminación LED</a> y <a href="/servicios/alquiler-moving-heads" class="text-primary-600 hover:underline font-semibold">moving heads</a>.`,
