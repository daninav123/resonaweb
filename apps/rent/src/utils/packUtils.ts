...
import { getImageUrl, getRelativePath } from '@resona/utils';
...
/**
 * Construye URL completa de imagen — delega en @resona/utils.
 */
...
/**
 * Convierte URL completa a ruta relativa — delega en @resona/utils.
 */
export function getRelativeImagePath(fullUrl: string | null | undefined): string | undefined {
  const result = getRelativePath(fullUrl);
